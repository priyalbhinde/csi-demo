    ...
    <figure className="absolute left-0 stroke-zinc-900">
      <svg width="75" height="75" viewBox="0 0 100 100">
        <circle
          ...
          cy="27"
          r="20"
          className="fill-none stroke-blue-600 stroke-1"
        />
        <motion.circle
          style={{
        ...
        <circle
          ...
          cy="27"
          r="10"
          className="fill-blue-600 stroke-1 dark:fill-blue-400"
        />
      </svg>
    </figure>
  );
...
export default function ShowCaseList(props: TShowCaseList) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 sm:px-14 md:px-20">
      <h2 className="md:mb-30 mb-16 w-full bg-gradient-to-r bg-clip-text text-center text-3xl font-bold text-transparent bg-blue-200 dark:bg-blue-800 xs:text-4xl sm:text-6xl md:text-8xl">
        {props.title}
      </h2>
      <div ref={ref} className="relative w-full md:mx-auto md:w-[80%]">
        <motion.div
          style={{ scaleY: scrollYProgress }}
          className="absolute left-9 top-5 h-full w-[5px] origin-top rounded-lg bg-blue-200 dark:bg-blue-800"
        ></motion.div>
